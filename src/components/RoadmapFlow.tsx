...
const RoadmapFlow: React.FC = () => {
  ...
  if (!currentRoadmap) {
    return (
      <div className="flex flex-col items-center justify-center w-full mx-auto px-0 md:px-4 max-w-full">
        {/* Main title section */}
        <div className="w-full max-w-4xl mx-auto text-center bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm p-6 sm:p-8 md:p-10 rounded-2xl shadow-xl border border-blue-100/50 dark:border-indigo-800/50 mb-10">
        ...
        {/* Community Statistics Section - Separated */}
        <div className="w-full max-w-4xl mx-auto text-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-indigo-100/50 dark:border-indigo-800/50 shadow-lg mt-10">
