      ...
      <div className="flex items-center justify-center h-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-950 dark:to-gray-800 p-3 sm:p-4 md:p-8 bg-pattern">
        <div className="w-full max-w-4xl text-center bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm p-6 sm:p-8 md:p-10 rounded-2xl shadow-xl border border-blue-100/50 dark:border-indigo-800/50 transition-all duration-300">
          ...
          <div className="relative w-full h-64 md:h-80 overflow-hidden mb-10 md:mb-12">
            ...
            <div className="absolute left-[5%] md:left-[12%] top-[15%] animate-float-slow floating-element">
              <div className="relative w-16 h-16 md:w-24 md:h-24">
                ...
                <div className="absolute inset-1 rounded-xl bg-white dark:bg-gray-800 backdrop-blur-sm flex items-center justify-center">
                  <svg className="w-8 h-8 md:w-10 md:h-12 text-cyan-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="absolute right-[8%] md:right-[15%] top-[20%] md:top-[15%] animate-float-medium floating-element">
              <div className="relative w-14 h-14 md:w-20 md:h-20">
                ...
                <div className="absolute inset-1 rounded-xl bg-white dark:bg-gray-800 backdrop-blur-sm flex items-center justify-center">
                  <svg className="w-7 h-7 md:w-10 md:h-10 text-violet-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="absolute left-[18%] md:left-[18%] bottom-[20%] md:bottom-[5%] animate-float-medium floating-element">
              <div className="relative w-20 h-20 md:w-28 md:h-28">
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 opacity-70 blur"></div>
                <div className="absolute inset-1 rounded-xl bg-white dark:bg-gray-800 backdrop-blur-sm flex items-center justify-center">
                  <svg className="w-10 h-10 md:w-14 md:h-14 text-indigo-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="absolute right-[5%] md:right-[9%] bottom-[8%] md:bottom-[5%] animate-float-slow floating-element">
              <div className="relative w-18 h-18 md:w-24 md:h-24">
                ...
                <div className="absolute inset-3.5 rounded-xl bg-white dark:bg-gray-800 backdrop-blur-sm flex items-center justify-center">
                  <svg className="w-9 h-9 md:w-12 md:h-12 text-blue-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="text-center mt-8 mb-6 md:mb-8 px-4">
            <h3 className="text-2xl md:text-3xl font-extrabold mb-5 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 dark:from-blue-400 dark:via-indigo-400 dark:to-violet-400">Select or Create a Learning Path</h3>
